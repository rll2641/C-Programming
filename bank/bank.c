...
/* 입금함수 */
void deposit(client *infor, client_b *infor_b, int index) {
...
/* 출금함수 */
void withdraw(client *infor, client_b *infor_b, int index) {
...
/* 계좌조회함수 */
void track_account(client *infor, client_b *infor_b, int index) {
...
void main_system() {
    ...
    while(1) {
        ...
        while(1) {
            ...
            if(input_num == 1) {
                system("cls");
                deposit(infor, infor_b, index);
                continue;
            }
            else if(input_num == 2) {
                system("cls");
                withdraw(infor, infor_b, index);
                continue;
            }
            else if(input_num == 3) {
                system("cls");
                track_account(infor, infor_b, index);
                continue;
            }
            else if(input_num == 4) {
                system("cls");
